...
class IndexedTensorDataset(TensorDataset):
    def __init__(self, *tensors, sample_weight=None):
        super().__init__(*tensors)
        self.sample_weight = sample_weight

    def __getitem__(self, index):
        # Get original tuple (e.g., (x, y))
        data = super().__getitem__(index)

        # Append weight and index
...
def glm_saga(linear, loader, max_lr, nepochs, alpha, 
             ...
             family='multinomial', encoder=None, max_sparsity=None, warm_start=True): 
